...
export const targetedNodesPrompt = `
**USER REQUEST:** "{prompt}"
...
export function getEnhancedPromptForApproach(
  approach: 'FULL_FILE' | 'TARGETED_NODES' | 'COMPONENT_ADDITION' | 'DEPENDENCY_UPDATE'
): string {
  switch (approach) {
    case 'FULL_FILE':
      return fullFilePrompt;
    case 'TARGETED_NODES':
      return targetedNodesPrompt;
...
export function getComponentPrompt(componentType: 'component' | 'page' | 'app'): string {
...
export function prepareFullFileVariables(
  userRequest: string,
  filePath: string,
  fileContent: string,
...
export function prepareLayoutChangeVariables(
  userRequest: string,
  filePath: string,
  fileContent: string,
  projectSummary: string,
...
export function prepareTargetedNodesVariables(
  prompt: string,
  filePath: string,
  componentName: string,
...
export function prepareComponentVariables(
  userRequest: string,
  componentName: string,
...
export function createLayoutRepairFunction() {
  return function repairFileStructureForLayout(
    ...
    try {
      ...
      let modifiedComponentContent: string[] = [];
